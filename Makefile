...
workflow_test_image_build-and-push:
	docker build -t sonataflow-minimal-example:latest ./test/testdata/workflow/docker-image/
	docker tag sonataflow-minimal-example:latest localhost:5001/sonataflow-minimal-example:0.1
	docker push localhost:5001/sonataflow-minimal-example:0.1
